...
const CarouselProvider = class CarouselProvider extends React.Component {
  ...
  constructor(props) {
    ...
    const options = {
      ...
      preventVerticalScrollOnTouch: props.preventVerticalScrollOnTouch,
      horizontalPixelThreshold: props.horizontalPixelThreshold,
      verticalPixelThreshold: props.verticalPixelThreshold,
