...
var ButtonBack$1 = function (_React$Component) {
...
function WithStore(WrappedComponent) {
  ...
  var Wrapper = function (_React$Component) {
    ...
    function Wrapper(props, context) {
      ...
      _this.state = mapStateToProps(_extends({}, context.carouselStore.state));
    ...
    createClass(Wrapper, [{
      ...
      value: function updateStateProps() {
        this.setState(mapStateToProps(_extends({}, this.context.carouselStore.state)));
      }
    }, {
      key: 'render',
      value: function render() {
...
var ButtonBack = WithStore(ButtonBack$1, function (state) {
  return {
...
var ButtonFirst$1 = (_temp = _class = function (_React$Component) {
...
var ButtonFirst = WithStore(ButtonFirst$1, function (state) {
  return {
    currentSlide: state.currentSlide,
...
var ButtonNext = WithStore(ButtonNext$1, function (state) {
  return {
    currentSlide: state.currentSlide,
    step: state.step,
    totalSlides: state.totalSlides,
...
var ButtonLast$1 = (_temp$2 = _class$2 = function (_React$Component) {
...
var ButtonLast = WithStore(ButtonLast$1, function (state) {
  return {
    currentSlide: state.currentSlide,
    totalSlides: state.totalSlides,
    visibleSlides: state.visibleSlides
...
var s$4 = { "buttonNext": "_buttonNext_p1bs6_1" };

var _class$3;
var _temp$3;

var ButtonPlay$1 = (_temp$3 = _class$3 = function (_React$PureComponent) {
  inherits(ButtonPlay, _React$PureComponent);

  function ButtonPlay(props) {
    classCallCheck(this, ButtonPlay);

    var _this = possibleConstructorReturn(this, (ButtonPlay.__proto__ || Object.getPrototypeOf(ButtonPlay)).call(this, props));

    _this.handleOnClick = _this.handleOnClick.bind(_this);
    return _this;
  }

  createClass(ButtonPlay, [{
    key: 'handleOnClick',
    value: function handleOnClick(ev) {
    ...
    value: function render() {
      var _props = this.props,
          ...
          childrenPaused = _props.childrenPaused,
          childrenPlaying = _props.childrenPlaying,
          className = _props.className,
          isPlaying = _props.isPlaying,
          onClick = _props.onClick,
          props = objectWithoutProperties(_props, ['carouselStore', 'children', 'childrenPaused', 'childrenPlaying', 'className', 'isPlaying', 'onClick']);


      var newClassName = cn([s$4.buttonNext, 'carousel__play-button', className]);
  ...
  return ButtonPlay;
}(react.PureComponent), _class$3.propTypes = {
  carouselStore: propTypes.object.isRequired,
...
var ButtonPlay = WithStore(ButtonPlay$1, function (state) {
  return {
...
var CarouselProvider$1 = (_temp$4 = _class$4 = function (_React$Component) {
  ...
  createClass(CarouselProvider, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      ['disableAnimation', 'hasMasterSpinner', 'interval', 'isPlaying', 'naturalSlideHeight', 'naturalSlideWidth', 'lockOnWindowScroll', 'orientation', 'playDirection', 'step', 'totalSlides', 'touchEnabled', 'dragEnabled', 'visibleSlides'].forEach(function (propName) {
...
var s$5 = { "dot": "_dot_27k82_1" };

var _class$5;
var _temp$5;

var Dot$1 = (_temp$5 = _class$5 = function (_React$Component) {
  ...
  createClass(Dot, [{
    ...
    value: function render() {
      ...
      var newClassName = cn([s$5.dot, newSelected && s$5.dotSelected, 'carousel__dot', 'carousel__dot--' + slide, newSelected && 'carousel__dot--selected', className]);
...
var DotGroup$1 = (_temp$6 = _class$6 = function (_React$Component) {
  ...
  createClass(DotGroup, [{
    ...
    value: function render() {
      ...
      var newClassName = cn([s$6.DotGroup, 'carousel__dot-group', className]);
...
var DotGroup = WithStore(DotGroup$1, function (state) {
  return {
    currentSlide: state.currentSlide,
    totalSlides: state.totalSlides,
    visibleSlides: state.visibleSlides
...
var Image$1 = function (_React$Component) {
  ...
  createClass(Image, [{
    ...
    value: function renderLoading(filteredProps) {
      ...
      var newClassName = cn([s$7.image, s$7.imageLoading, 'carousel__image', this.props.isBgImage && 'carousel__image--with-background', 'carousel__image--loading', this.props.className]);
    ...
    value: function renderError(filteredProps) {
      ...
      var newClassName = cn([s$7.image, s$7.imageError, 'carousel__image', this.props.isBgImage && 'carousel__image--with-background', 'carousel__image--error', this.props.className]);
    ...
    value: function renderSuccess(filteredProps) {
      ...
      var newClassName = cn([s$7.image, 'carousel__image', this.props.isBgImage && 'carousel__image--with-background', 'carousel__image--success', this.props.className]);
...
var s$8 = { "container": "_container_11gb8_1", "overlay": "_overlay_11gb8_8", "hover": "_hover_11gb8_19", "loading": "_loading_11gb8_24", "imageLoadingSpinnerContainer": "_imageLoadingSpinnerContainer_11gb8_28" };

var _class$7;
var _temp$7;

var ImageWithZoom$1 = (_temp$7 = _class$7 = function (_React$Component) {
  ...
  createClass(ImageWithZoom, [{
    ...
    value: function renderLoading() {
      if (this.state.isImageLoading) {
        return react.createElement(
          'div',
          {
            className: cn([s$8.imageLoadingSpinnerContainer, 'carousel__image-loading-spinner-container'])
          },
    ...
    value: function render() {
      ...
      var imageClassName = cn([s$8.image, 'carousel__zoom-image']);

      var overlayClassName = cn([s$8.overlay, 'carousel__zoom-image-overlay', this.state.hovering && s$8.hover, this.state.hovering && 'carousel__zoom-image-overlay--hovering']);
      ...
      return react.createElement(
        Tag,
        _extends({ className: s$8.container }, filteredProps),
...
var s$9 = { "slideInner": "_slideInner_fhwgk_1", "slideHorizontal": "_slideHorizontal_fhwgk_1", "slide": "_slide_fhwgk_1", "focusRing": "_focusRing_fhwgk_26" };

var _class$8;
var _temp$8;

var Slide$1 = (_temp$8 = _class$8 = function (_React$PureComponent) {
  ...
  createClass(Slide, [{
    ...
    value: function renderFocusRing() {
      if (this.state.focused) return react.createElement('div', { className: [s$9.focusRing, 'carousel__slide-focus-ring'].join(' ') });
      return null;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var newClassName = cn([s$9.slide, orientation === 'horizontal' && s$9.slideHorizontal, 'carousel__slide', this.state.focused && 'carousel__slide--focused', className]);

      var newInnerClassName = cn([s$9.slideInner, 'carousel__inner-slide', innerClassName]);
...
var Slide = WithStore(Slide$1, function (state) {
  return {
    currentSlide: state.currentSlide,
...
var s$10 = { "horizontalSlider": "_horizontalSlider_9ve3r_1", "horizontalSliderTray": "_horizontalSliderTray_9ve3r_1", "verticalSlider": "_verticalSlider_9ve3r_11", "verticalSliderTray": "_verticalSliderTray_9ve3r_1", "verticalTray": "_verticalTray_9ve3r_20", "verticalSlideTrayWrap": "_verticalSlideTrayWrap_9ve3r_24", "sliderTray": "_sliderTray_9ve3r_28", "sliderAnimation": "_sliderAnimation_9ve3r_35", "masterSpinnerContainer": "_masterSpinnerContainer_9ve3r_40" };

var _class$9;
var _temp$9;

var Slider$1 = (_temp$9 = _class$9 = function (_React$Component) {
  ...
  function Slider() {
    ...
    _this.playBackward = _this.playBackward.bind(_this);
    _this.playForward = _this.playForward.bind(_this);

    _this.handleOnMouseDown = _this.handleOnMouseDown.bind(_this);
    _this.handleOnMouseMove = _this.handleOnMouseMove.bind(_this);
    _this.handleOnMouseClick = _this.handleOnMouseClick.bind(_this);
    ...
    _this.interval = null;
    _this.isDocumentScrolling = null;
  ...
  createClass(Slider, [{
    ...
    key: 'onDragStart',
    value: function onDragStart(screenX, screenY, touchDrag, mouseDrag) {
      this.props.carouselStore.setStoreState({
        isPlaying: false
      });
    ...
    value: function onDragMove(screenX, screenY) {
      ...
      this.moveTimer = window.requestAnimationFrame.call(window, function () {
        _this2.setState({
          deltaX: screenX - _this2.state.startX,
          deltaY: screenY - _this2.state.startY,
          mouseIsMoving: _this2.state.isBeingMouseDragged
        });
      });
    }
  }, {
    ...
    value: function handleOnMouseDown(ev) {
    ...
    key: 'handleOnMouseClick',
    value: function handleOnMouseClick(ev) {
      if (!this.props.dragEnabled || !this.state.isBeingMouseDragged) return;
    ...
    value: function handleOnTouchMove(ev) {
      if (!this.props.touchEnabled || this.props.lockOnWindowScroll && this.isDocumentScrolling) return;
    ...
    value: function playForward() {
      var _props4 = this.props,
          carouselStore = _props4.carouselStore,
          currentSlide = _props4.currentSlide;
    ...
    value: function playBackward() {
      var _props5 = this.props,
          carouselStore = _props5.carouselStore,
          currentSlide = _props5.currentSlide,
          totalSlides = _props5.totalSlides,
          visibleSlides = _props5.visibleSlides;

      carouselStore.setStoreState({
        currentSlide: this.backward() === currentSlide ? totalSlides - visibleSlides : this.backward()
      });
    }
  }, {
    key: 'play',
    value: function play() {
      var playDirection = this.props.playDirection;
    ...
    value: function renderMasterSpinner() {
      ...
      if (hasMasterSpinner && !masterSpinnerFinished) {
        ...
        return react.createElement(
          'div',
          {
            className: cn([s$10.masterSpinnerContainer, 'carousel__master-spinner-container'])
          },
          react.createElement(Spinner$1, null)
        );
      }
    ...
    value: function render() {
      ...
      var _props7 = this.props,
          ...
          classNameAnimation = _props7.classNameAnimation,
          classNameTray = _props7.classNameTray,
          classNameTrayWrap = _props7.classNameTrayWrap,
          currentSlide = _props7.currentSlide,
          disableAnimation = _props7.disableAnimation,
          dragEnabled = _props7.dragEnabled,
          hasMasterSpinner = _props7.hasMasterSpinner,
          interval = _props7.interval,
          isPlaying = _props7.isPlaying,
          lockOnWindowScroll = _props7.lockOnWindowScroll,
          masterSpinnerFinished = _props7.masterSpinnerFinished,
          naturalSlideHeight = _props7.naturalSlideHeight,
          naturalSlideWidth = _props7.naturalSlideWidth,
          onMasterSpinner = _props7.onMasterSpinner,
          ...
          props = objectWithoutProperties(_props7, ['carouselStore', 'children', 'className', 'classNameAnimation', 'classNameTray', 'classNameTrayWrap', 'currentSlide', 'disableAnimation', 'dragEnabled', 'hasMasterSpinner', 'interval', 'isPlaying', 'lockOnWindowScroll', 'masterSpinnerFinished', 'naturalSlideHeight', 'naturalSlideWidth', 'onMasterSpinner', 'orientation', 'playDirection', 'slideSize', 'slideTraySize', 'style', 'tabIndex', 'totalSlides', 'touchEnabled', 'trayTag', 'visibleSlides']);
      ...
      var sliderClasses = cn([orientation === 'vertical' ? s$10.verticalSlider : s$10.horizontalSlider, 'carousel__slider', orientation === 'vertical' ? 'carousel__slider--vertical' : 'carousel__slider--horizontal', className]);

      var trayWrapClasses = cn([s$10.sliderTrayWrap, 'carousel__slider-tray-wrapper', orientation === 'vertical' ? s$10.verticalSlideTrayWrap : s$10.horizontalTrayWrap, orientation === 'vertical' ? 'carousel__slider-tray-wrap--vertical' : 'carousel__slider-tray-wrap--horizontal', classNameTrayWrap]);

      var trayClasses = cn([s$10.sliderTray, classNameAnimation || s$10.sliderAnimation, 'carousel__slider-tray', orientation === 'vertical' ? s$10.verticalTray : s$10.horizontalTray, orientation === 'vertical' ? 'carousel__slider-tray--vertical' : 'carousel__slider-tray--horizontal', classNameTray]);
...
var Slider = WithStore(Slider$1, function (state) {
  return {
    currentSlide: state.currentSlide,
...
var s$11 = { "spinner": "_spinner_1dguc_1", "spin": "_spin_1dguc_1" };

var _class$10;
var _temp$10;

var Spinner$1 = (_temp$10 = _class$10 = function (_React$PureComponent) {
  ...
  createClass(Spinner, [{
    ...
    value: function render() {
      ...
      var newClassName = cn([s$11.spinner, 'carousel__spinner', className]);
      return react.createElement('div', _extends({ className: newClassName }, filteredProps));
    }
  }]);
  return Spinner;
}(react.PureComponent), _class$10.propTypes = {
  className: propTypes.string
...
var s$12 = { "headline": "_headline_xgf5a_9", "slider": "_slider_xgf5a_13", "verticalSlider": "_verticalSlider_xgf5a_17" };

var Example1$1 = (function () {
  return react.createElement(
    CarouselProvider$1,
    {
      visibleSlides: 3,
    ...
    react.createElement(
      'h1',
      { className: s$12.headline },
      'Carousel (With Master Loading Spinner)'
    ),
    react.createElement(
      'p',
      null,
      'This spinner will go away after all the images have loaded. You might want to use Chrome dev tools to throttle the network connection so you can see the spinner.'
    ),
    react.createElement(
      Slider,
      { className: s$12.slider },
      react.createElement(
        Slide,
        { index: 0 },
        react.createElement(ImageWithZoom$1, { src: './media/img01.jpeg' })
      ),
      react.createElement(
        Slide,
        { index: 1 },
    ...
    react.createElement(DotGroup, null)
  );
});

var Example2$1 = (function () {
  return react.createElement(
    CarouselProvider$1,
    {
      visibleSlides: 2,
    ...
    react.createElement(
      'p',
      null,
      'Each ImageWithZoom component has it\'s own spinner. You might want to use Chrome dev tools to throttle the network connection so you can see the spinners.'
    ),
    react.createElement(
      'p',
      null,
    ...
    react.createElement(DotGroup, { dotNumbers: true })
  );
});

var Example3$1 = (function () {
  return react.createElement(
    CarouselProvider$1,
    {
      visibleSlides: 2,
...
var Example4$1 = (function () {
  return react.createElement(
    ...
    react.createElement(
      'p',
      null,
      'TODO: make vertical carousels responsive based on image.  It can be done but it\'s not part of the requirements for now.'
    ),
    react.createElement(
      Slider,
      { className: s$12.verticalSlider },
      react.createElement(
        Slide,
        { index: 0 },
        react.createElement(ImageWithZoom$1, { src: './media/img01.jpeg' })
  ...
  return react.createElement(
    ...
    react.createElement(
      ...
      react.createElement(
        Slide,
        { tag: 'a', index: 0 },
        react.createElement(Image, { src: './media/img01.jpeg' })
      ),
      react.createElement(
        Slide,
        { tag: 'a', index: 1 },
        react.createElement(Image, { src: './media/img02.jpeg' })
      ),
      react.createElement(
        Slide,
        { tag: 'a', index: 2 },
        react.createElement(Image, { src: './media/img03.jpeg' })
      ),
      react.createElement(
        Slide,
        { tag: 'a', index: 3 },
        react.createElement(Image, { src: './media/img04.jpeg' })
      ),
      react.createElement(
        Slide,
        { tag: 'a', index: 4 },
        react.createElement(Image, { src: './media/img05.jpeg' })
      ),
      react.createElement(
        Slide,
        { tag: 'a', index: 5 },
        react.createElement(Image, { src: './media/img06.jpeg' })
      )
    ),
    react.createElement(
      ButtonFirst,
...
var s$13 = { "headline": "_headline_16azs_1", "container": "_container_16azs_5", "buttonBack": "_buttonBack_16azs_11", "buttonNext": "_buttonNext_16azs_18", "dotGroup": "_dotGroup_16azs_26" };

var Example6$1 = (function () {
  return react.createElement(
    CarouselProvider$1,
    {
      visibleSlides: 3,
    ...
    react.createElement(
      ...
      react.createElement(
        ButtonBack,
        { className: s$13.buttonBack },
        'Back'
      ),
      react.createElement(
        ButtonNext,
        { className: s$13.buttonNext },
        'Next'
      )
    ),
    react.createElement(DotGroup, { className: s$13.dotGroup })
  );
});
...
var INCREMENT = 'demo/INCREMENT';
var DECREMENT = 'demo/DECREMENT';
    ...
    case DECREMENT:
      {
        ...
        _count -= 1;
        return _extends({}, state, { count: _count });
      }
    default:
      return state;
  }
...
var s$14 = { "container": "_container_1nx61_1" };

var SlideComponent$1 = function (_React$Component) {
  inherits(SlideComponent, _React$Component);

  function SlideComponent() {
    classCallCheck(this, SlideComponent);

    var _this = possibleConstructorReturn(this, (SlideComponent.__proto__ || Object.getPrototypeOf(SlideComponent)).call(this));
...
SlideComponent$1.propTypes = {
  count: propTypes.number.isRequired,
  setIncrement: propTypes.func.isRequired,
  setDecrement: propTypes.func.isRequired,
  children: propTypes.node
};
SlideComponent$1.defaultProps = {
  children: null
};

var SlideComponent = connect(function (state) {
  return { count: state.demoReducer.count };
}, { setIncrement: setIncrement, setDecrement: setDecrement })(SlideComponent$1);

var s$15 = { "container": "_container_3830k_1", "slider": "_slider_3830k_6", "slide": "_slide_3830k_6" };

var Example7$1 = (function () {
  return react.createElement(
    CarouselProvider$1,
    {
      visibleSlides: 3,
    ...
    react.createElement(
      ...
      react.createElement(
        Slider,
        { className: s$15.slider },
        react.createElement(
          Slide,
          { className: s$15.slide, index: 0 },
          react.createElement(SlideComponent, null)
        ),
        react.createElement(
          Slide,
          { className: s$15.slide, index: 1 },
          react.createElement(SlideComponent, null)
        ),
        react.createElement(
          Slide,
          { className: s$15.slide, index: 2 },
          react.createElement(SlideComponent, null)
        ),
        react.createElement(
          Slide,
          { className: s$15.slide, index: 3 },
          react.createElement(SlideComponent, null)
        ),
        react.createElement(
          Slide,
          { className: s$15.slide, index: 4 },
          react.createElement(SlideComponent, null)
        ),
        react.createElement(
          Slide,
          { className: s$15.slide, index: 5 },
          react.createElement(SlideComponent, null)
        )
      ),
      react.createElement(
        ButtonBack,
        { className: s$15.buttonBack },
        'Back'
      ),
      react.createElement(
        ButtonNext,
        { className: s$15.buttonNext },
        'Next'
      )
    ),
    react.createElement(DotGroup, { className: s$15.dotGroup })
  );
});

// create a redux store to store application state
/* eslint-disable no-underscore-dangle */
var store = createStore(combineReducers({ demoReducer: reducer }), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
/* eslint-enable */
...
var Example7 = (function () {
  return react.createElement(
    Provider,
    { store: store },
    react.createElement(Example7$1, null)
  );
});

var Example8$1 = (function () {
  return react.createElement(
    CarouselProvider$1,
    {
      visibleSlides: 1,
...
var DevelopmentApp = function (_React$Component) {
  inherits(DevelopmentApp, _React$Component);

  function DevelopmentApp() {
    classCallCheck(this, DevelopmentApp);

    var _this = possibleConstructorReturn(this, (DevelopmentApp.__proto__ || Object.getPrototypeOf(DevelopmentApp)).call(this));
    ...
    value: function render() {
      return react.createElement(
        ...
        react.createElement(
          'p',
          null,
          'Use the Select input below to switch between views.  This is usefull for testing to make sure that mount and unmount happens cleanly.'
        ),
        react.createElement(
          'select',
          { className: s$12.select, value: this.state.value, onChange: this.handleChange },
          react.createElement(
            'option',
            { value: '0' },
            'Show All'
        ...
        (this.state.value === '0' || this.state.value === '1') && react.createElement(
          'section',
          { id: 'example--1' },
          react.createElement(Example1$1, null)
        ),
        (this.state.value === '0' || this.state.value === '2') && react.createElement(
          'section',
          { id: 'example--2' },
          react.createElement(Example2$1, null)
        ),
        (this.state.value === '0' || this.state.value === '3') && react.createElement(
          'section',
          { id: 'example--3' },
          react.createElement(Example3$1, null)
        ),
        (this.state.value === '0' || this.state.value === '4') && react.createElement(
          'section',
          { id: 'example--4' },
          react.createElement(Example4$1, null)
        ),
        (this.state.value === '0' || this.state.value === '5') && react.createElement(
          'section',
          { id: 'example--5' },
          react.createElement(Example5$1, null)
        ),
        (this.state.value === '0' || this.state.value === '6') && react.createElement(
          'section',
          { id: 'example--6' },
          react.createElement(Example6$1, null)
        ),
        (this.state.value === '0' || this.state.value === '7') && react.createElement(
          'section',
          { id: 'example--7' },
          react.createElement(Example7, null)
        ),
        (this.state.value === '0' || this.state.value === '8') && react.createElement(
          'section',
          { id: 'example--8' },
          react.createElement(Example8$1, null)
        ),
        (this.state.value === '0' || this.state.value === '9') && react.createElement(
          'section',
          { id: 'example--9' },
          react.createElement(Example9$1, null)
        )
      );
    }
  }]);
